...
/*** SHOW-LAYOUT HELPER ***/
function gidd_add_layout_style( $layout, $path, $measure, $media = "screen,projection" ) {
		
	$style  = '<link rel="stylesheet" href="' . $path;
	$style .= '" type="text/css" media="' . $media .'"/>';
	
	//add ie hack
	$layout = ( $layout == "" ) ? "bootstrap16" : $layout;
	...
	echo apply_filters( "gidd_layout_style", $style );
}
