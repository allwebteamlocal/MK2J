...
add_filter('comment_reply_link', 'gidd_replace_reply_link_class');
function gidd_replace_reply_link_class($class){
    $class = str_replace("class='comment-reply-link", "class='comment-reply-link btn btn-success btn-sm", $class);
    return $class;
}
