...
*	1. The theme file such as single.php calls comments_template() function
	...
	<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
		...
		<div class="comment-meta commentmetadata">
			...
			<?php
				...
				printf(  __(  '%1$s at %2$s', 'gidd'  ), get_comment_date(),  get_comment_time()  ); ?></a>
			<?php edit_comment_link(  __(  '- Edit this comment', 'gidd'  ), ' '  ); ?>
...
function ___comment( $seperate = false ){
	comments_template( '/'. GIDDNAME .'/core_extension/gidd_comment/comments.php', $seperate );
}
